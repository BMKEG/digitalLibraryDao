...
import edu.isi.bmkeg.digitalLibrary.cleartk.annotators.AddFuzzyBratAnnotations;
import edu.isi.bmkeg.digitalLibrary.cleartk.annotators.AddFragmentsAndCodes;
import edu.isi.bmkeg.digitalLibrary.cleartk.annotators.BratFragmentWriter;
import edu.isi.bmkeg.digitalLibrary.cleartk.cr.DigitalLibraryCollectionReader;

public class TranslateBratFragments {
	...
	public static class Options {
		...
		@Option(name = "-outBrat", usage = "Brat Annotations", required = true)
		public File outBrat;
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			builder.add(AnalysisEngineFactory.createPrimitiveDescription(
					AddFuzzyBratAnnotations.class,
					AddFuzzyBratAnnotations.BRAT_DATA_DIRECTORY, options.inBrat
					));
			...
			String dirPath = options.outBrat.getPath();

			builder.add(AnalysisEngineFactory.createPrimitiveDescription(
					BratFragmentWriter.class,
					BratFragmentWriter.FRAGMENT_TYPE, options.frgType,
					BratFragmentWriter.PARAM_DIR_PATH, dirPath));
